          ...
          <div className="prose prose-gray max-w-none space-y-8 text-[#4E5968]">
            ...
            <section>
              ...
              <ul className="list-decimal pl-6 mt-3 space-y-2">
                ...
                <li>"진로분석 학습권"이란 서비스 내에서 AI 기능을 이용하기 위해 필요한 디지털 화폐를 말합니다.</li>
                <li>"기프트 학습권(GP)"이란 회사가 무료로 제공하는 학습권으로, 유효기간이 있으며 선입선출 방식으로 사용됩니다.</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#191F28] mb-4">제6조 (진로분석 학습권 및 결제)</h2>
              <ul className="list-decimal pl-6 mt-3 space-y-2">
                <li>회원은 진로분석 학습권을 구매하여 AI 서비스를 이용할 수 있습니다.</li>
                <li>기프트 학습권(GP)은 유효기간 내에만 사용 가능하며, 유효기간이 경과하면 자동으로 소멸됩니다.</li>
                <li>학습권은 현금으로 환불되지 않으며, 회원 탈퇴 시 잔여 학습권은 소멸됩니다.</li>
            ...
            <section>
              ...
              <ul className="list-decimal pl-6 mt-3 space-y-2">
                ...
                <li>AI 서비스 이용 시 소모되는 학습권은 환불되지 않습니다.</li>
              </ul>
            </section>
