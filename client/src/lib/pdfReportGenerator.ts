        ...
        <div style="background: linear-gradient(135deg, #0F1E3D 0%, #1a2d5c 100%); padding: 30px; margin: -40px -40px 30px -40px; border-radius: 0;">
          <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div style="text-align: right;">
              ...
              <div style="margin-top: 12px; background: linear-gradient(135deg, #D4AF37, #F5D76E); color: #0F1E3D; padding: 8px 16px; border-radius: 20px; font-size: 10px; font-weight: 700; display: inline-flex; align-items: center; justify-content: center; line-height: 1;">
                CERTIFIED REPORT
              </div>
            </div>
          </div>
        ...
        <div style="background: linear-gradient(135deg, #F0F9FF 0%, #E0F2FE 100%); padding: 20px; border-radius: 12px; margin-bottom: 25px;">
          <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
              <span style="background: #0EA5E9; color: white; padding: 8px 14px; border-radius: 20px; font-size: 12px; font-weight: 600; display: inline-flex; align-items: center; justify-content: center; line-height: 1;">${getProfileTypeKorean(data.profileType)}</span>
              ${data.fitScore !== undefined ? `
                <span style="background: linear-gradient(135deg, #3182F6, #1565C0); color: white; padding: 8px 14px; border-radius: 20px; font-size: 12px; font-weight: 600; display: inline-flex; align-items: center; justify-content: center; line-height: 1;">적합도 ${data.fitScore}점</span>
              ` : ''}
            </div>
          </div>
        </div>
